...
public class CommandTBTeleport extends TombstoneCommand {
    ...
    private int teleport(CommandSource sender, Entity source, int x, int y, int z, ServerWorld targetWorld) {
        ...
        sendMessage(sender, LangKey.MESSAGE_TELEPORT_TARGET_TO_LOCATION.getText(newEntity.getName(), LangKey.MESSAGE_HERE.getText(), destLoc.x, destLoc.y, destLoc.z, destLoc.dim.func_240901_a_().toString()), false);
        return 1;
    }
}
